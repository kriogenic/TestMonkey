...
namespace TestMonkey.Upgrades.TopPath
{
    public class Pair : ModUpgrade<TestMonkey>
    {
        ...
        {
            //We want to try get towers in our radius


           // tower.GetTowerToSim().tower.GetTowersInRange();
